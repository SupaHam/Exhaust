...
import net.ellune.exhaust.bungee.provider.BungeeModule;
import net.ellune.exhaust.bungee.provider.core.CommandSenderProvider;
import net.ellune.exhaust.bungee.provider.core.ProxiedPlayerProvider;
import net.ellune.exhaust.bungee.provider.core.ProxiedPlayerSenderProvider;
